...
const Team = () => {
  ...
  return (
    <main className="nico-team-page">
        ...
        {allStaff.map((member, index) => (
          <div key={index} className="nico-premium-card">
            ...
            <div className="nico-content-box">
              ...
              {member.company && (
                <p className="nico-company-tag">{member.company}</p>
              )}
      ...
      {selectedMember && (
        <div
          className="nico-modal-overlay"
          onClick={() => setSelectedMember(null)}
        >
          <div
            className="nico-modal-content"
            onClick={(event) => event.stopPropagation()}
          >
            <button
              className="nico-close-modal"
              onClick={() => setSelectedMember(null)}
            >
              &times;
            </button>
            ...
            <div className="nico-modal-details">
              ...
              {selectedMember.company && (
                <p className="modal-company">{selectedMember.company}</p>
              )}
