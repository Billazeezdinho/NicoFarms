        ...
        <section className="mt-16 bg-green-50 p-8 rounded-lg">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              Kenneth and Raji share a common vision of transforming Nigeria's
              poultry industry through sustainable, responsible farming
              practices. Their partnership combines agricultural expertise with
              business acumen to create a farm that prioritizes quality,
